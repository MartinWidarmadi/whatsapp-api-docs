      ...
      "data": [
        {
          ...
          "filename": "discussion_result.pdf",
          "file_url": "https://assets.protocol.chat/attachments/discussion_result.pdf",
...
<Row>
  ...
  <Col sticky>
    ...
    await client.attachments.update('Nc6yKKMpcxiiFxp6', {
      filename: 'discussion_result_updated.pdf',
    })
    ```
    ...
    ```json {{ title: 'Response' }}
    {
      ...
      "message_id": "LoPsJaMcPBuFNjg1",
      "filename": "discussion_result.pdf",
      "file_url": "https://assets.protocol.chat/attachments/discussion_result_updated.pdf",
      "file_type": "application/pdf",
      "file_size": 1230340,
      "created_at": 692233200
    }
